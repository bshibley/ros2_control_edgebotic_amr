#ifndef ROS2_CONTROL_EDGEBOTIC_AMR__ARDUINO_COMMS_H_
#define ROS2_CONTROL_EDGEBOTIC_AMR__ARDUINO_COMMS_H_
...
#endif // ROS2_CONTROL_EDGEBOTIC_AMR__ARDUINO_COMMS_H_